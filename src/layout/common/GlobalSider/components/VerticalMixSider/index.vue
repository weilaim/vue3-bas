...
import { GlobalLogo } from '@/layout/common';
import { MixMenuDetail, MixMenuCollapse, MixMenuDrawer } from './components';
...
function setActiveParentRouteName(ParenRouteName: string) {
  activeParentRouteName.value = ParenRouteName;
}
/**
 * 获取激活的父级路由名字
 */
